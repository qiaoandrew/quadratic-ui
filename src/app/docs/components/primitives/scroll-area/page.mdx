...
<DocLinks>
  <DocLink href="https://www.radix-ui.com/docs/primitives/components/scroll-area" icon="file-code-2">Docs</DocLink>
  <DocLink href="https://www.radix-ui.com/docs/primitives/components/scroll-area#api-reference" icon="code-xml">API Reference</DocLink>
</DocLinks>
...
<Footer previousLabel="Radio Group" previousHref="/docs/components/primitives/radio-group" nextLabel="Select" nextHref="/docs/components/primitives/select" />
