...
export const metadata = {
  title: "Navigation Menu | quadratic/ui",
...
<StepTitle>Ensure you have installed `_Link.tsx` as described in the [Quickstart](/docs/getting-started/guides/quickstart) guide.</StepTitle>

<StepTitle>Ensure you have installed the necessary customizations to your `globals.css` file as described in the [Quickstart](/docs/getting-started/guides/quickstart) guide.</StepTitle>
