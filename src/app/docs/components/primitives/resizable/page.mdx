...
<Footer previousLabel="Radio Group" previousHref="/docs/components/patterns/radio-group" nextLabel="Scroll Area" nextHref="/docs/components/patterns/scroll-area" />