...
<Footer previousLabel="Toggle Group" previousHref="/docs/components/primitives/toggle-group" nextLabel="Combobox" nextHref="/docs/components/primitives/combobox" />
