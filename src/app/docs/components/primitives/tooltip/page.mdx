...
<DocLinks>
  <DocLink href="https://www.radix-ui.com/docs/primitives/components/tooltip" icon="file-code-2">Docs</DocLink>
  <DocLink href="https://www.radix-ui.com/docs/primitives/components/tooltip#api-reference" icon="code-xml">API Reference</DocLink>
</DocLinks>
...
<Footer previousLabel="Toggle Group" previousHref="/docs/components/primitives/toggle-group" />
