...
<StepTitle>Ensure you have added the necessary customizations to your `globals.css` file as described in the [Quickstart](/docs/getting-started/guides/quickstart) guide.</StepTitle>
</Steps>
