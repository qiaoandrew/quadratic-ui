...
<DocLinks>
  <DocLink href="https://www.radix-ui.com/docs/primitives/components/popover" icon="file-code-2">Docs</DocLink>
  <DocLink href="https://www.radix-ui.com/docs/primitives/components/popover#api-reference" icon="code-xml">API Reference</DocLink>
</DocLinks>
