...
<Footer previousLabel="Resizable" previousHref="/docs/components/patterns/resizable" nextLabel="Charts Introduction" nextHref="/docs/components/charts/introduction" />
