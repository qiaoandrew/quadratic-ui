...
<Footer previousLabel="Date Picker" previousHref="/docs/components/composites/date-picker" nextLabel="Data Table" nextHref="/docs/components/patterns/data-table" />
