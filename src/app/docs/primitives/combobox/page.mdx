...
<StepTitle>Combobox is built using a composition of the `<Popover />` and `<Command />` components. Follow installation for [Popover](/docs/primitives/popover) and [Button](/docs/primitives/button).</StepTitle>
...
<Footer previousLabel="Collapsible" previousHref="/docs/primitives/collapsible" nextLabel="Command" nextHref="/docs/primitives/command" />
