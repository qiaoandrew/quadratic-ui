...
<StepTitle>Add a `components/ui/_VisuallyHidden.tsx` file. This is to hide content visually but still allow it to be read by screen readers.</StepTitle>
<StepContent>
<FileSource id="_visuallyHidden" />
</StepContent>
