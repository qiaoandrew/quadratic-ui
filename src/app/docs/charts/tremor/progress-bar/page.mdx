...
export const metadata = {
  title: "Progress Bar | quadratic/ui",
  description: "Visual element to indicate progress, performance, or status represented in a linear way.",
};

<Title>Progress Bar</Title>
<Description>Visual element to indicate progress, performance, or status represented in a linear way.</Description>
<ComponentPreview id="tremorProgressBar" />