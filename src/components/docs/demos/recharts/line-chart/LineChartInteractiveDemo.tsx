...
export default function LineChartInteractiveDemo() {
  const [activeChart, setActiveChart] =
    useState<keyof typeof CHART_CONFIG>("desktop");
  ...
  return (
    <div className="flex w-full flex-col gap-y-6">
        ...
        {["desktop", "mobile"].map((key) => {
          ...
          return (
            <button
              ...
              className={cn(
                "relative z-30 flex flex-1 flex-col justify-center gap-y-0.5 px-5 py-3 text-left transition-colors",
                "data-[active=true]:bg-muted/50",
                "sm:gap-y-1 sm:px-8 sm:py-6",
              )}
      ...
      <ChartContainer config={CHART_CONFIG} className="min-h-56 w-full">
        <LineChart
          accessibilityLayer
          data={CHART_DATA}
          margin={{
